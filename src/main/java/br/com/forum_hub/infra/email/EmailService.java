...
public class EmailService {
  ...
  public void enviarEmailVerificacao(Usuario usuario) {
    ...
    String conteudo = gerarConteudoEmail(
        "Olá [[name]],<br>" + "Por favor clique no link abaixo para verificar sua conta:<br>"
            + "<h3><a href=\"[[URL]]\" target=\"_self\">VERIFICAR</a></h3>" + "Obrigado,<br>"
            + "Fórum Hub :).", usuario.getNomeCompleto(),
